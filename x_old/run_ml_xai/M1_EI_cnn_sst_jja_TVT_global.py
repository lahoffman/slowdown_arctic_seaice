...
for l in range(9):
    ...
    n_runs = 1              # 👈 number of seeds per experiment
    ...
    for e_idx, k in enumerate(experiments):
        for r_idx in range(n_runs):
            ...
            model.save(f"/globalscratch/ucl/elic/lhoffman/K_robustness/M1_S_model_cnn_masking_EI.{k}_R{r_idx}_JJA_TVTsplit{l}_globalSTD.h5") 
    ...
    savepath = f"/globalscratch/ucl/elic/lhoffman/K_robustness/M1_S_EI.X_performance_TVT_split{l}_multiRun_JJA_globalSTD.nc"
