...
for e_idx, k in enumerate(range(1)):
    for r_idx in range(50):
        ...
        #load model
        #----------------------------------------
        loadpath_model = f"/globalscratch/ucl/elic/lhoffman/K_robustness/M1_model_cnn_masking_EI.{k}_R{r_idx}_JJA_globalSTD.h5"
        ...
        savepath = f'/globalscratch/ucl/elic/lhoffman/K_robustness/M2_EI.{k}-{r_idx}_lrpz_JJA_global.nc'
